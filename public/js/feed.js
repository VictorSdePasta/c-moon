    ...
    if (resposta.ok) {
      ...
      resposta.json().then(function (resposta) {
        ...
        for (let i = 0; i < resposta.length; i++) {
          ...
          let pubSubgenres = ``
          let pubSubg = publicacao.postSubg
          for (let j = 0; j < pubSubg.length; j++) {
            pubSubgenres += `#${pubSubg[j]} `
          }
          ...
          if (publicacao.postImg > 0) {
            msg += `<img src="${publicacao.postImg}">`
          }
          ...
          msg +=
            `</div>
              <div class="description">
                ...
                <div class="sinopse">
                  <span id="spanSinopseHist">${publicacao.tale}</span>
                  <div class="buttons">
                    <button class="like" onclick="like(${publicacao.idPost})"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div id="divLikes">${publicacao.likes}</div>
                    `
          // `<button class="comment" onclick="comment(${publicacao.idPost})"><svg xmlns="http://www.w3.org/2000/svg"
          ...
          //   </svg></button>
          // <div id="divComments${publicacao.idPost}">${publicacao.comments}</div>`
          msg +=
            `<button onclick="seeMore(${publicacao.idPost})" class="seeMore">Ver Rumor</button>
                  </div>
                </div>
              </div>
            </div>`
          ...
          //   msg +=
          //     `<div class="highlightedComment" id="higlight${publicacao.idPost}${publicacao.idComment}">
          //       <div class="user">
          //         <div class="profile"></div>
          //         <h3 id="h3PostCommentUserName">${publicacao.userNameComment}</h3>
          //       </div>
          //       <div class="description">
          //         <span id="spanCommentUser">${publicacao.highUserComment}</span>
          //         <div class="buttons">
          //           <button class="like" onclick="like(${publicacao.idComment})"><svg xmlns="http://www.w3.org/2000/svg"
          //               xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" viewBox="0 0 42.532 42.532"
          //               xml:space="preserve">
          //               <g>
          //                 <path
          ...
          //           <button class="reply" onclick="reply(${publicacao.idPost}${publicacao.idComment})"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
          //               fill="none">
